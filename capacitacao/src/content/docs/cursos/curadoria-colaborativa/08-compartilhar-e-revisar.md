---
title: 8. Compartilhar e revisar
description: Como levar a pré-ficha para o grupo, e o que um revisor deve checar.
duration_minutes: 6
objectives:
  - Produzir uma mensagem de WhatsApp a partir de uma pré-ficha
...
Nas primeiras experiências, mencione também a [proposta geral do projeto](https://github.com/conscienciologia/prototipos/blob/main/curadoria/PROPOSTA.md) — ajuda quem lê a entender que não é só um resumo, é um processo experimental em avaliação.
