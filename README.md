...
- **[`capacitacao/`](capacitacao/)** — publicar cursos/treinamentos navegáveis. Contém hoje o treinamento real "Uso Cosmoético da Inteligência Artificial", de Túlio Vieira de Souza. Ver [capacitacao/README.md](capacitacao/README.md).

Nenhuma das duas é definitiva. Nenhuma exige que todo mundo aprenda Git ou GitHub para participar — GitHub é infraestrutura do protótipo, não a interface esperada para todo participante.
